...
Beyond calculating the welfare losses from road network inefficiencies following \citet{fajgelbaum2020optimal} and \citet{graff2024spatial}, we quantify the investments needed to overcome the welfare losses from infrastructure misallocation. We also analyze what percentage of these losses are due to the prioritization of peripheral roads instead of inter-city connectivity and thus explore the growth-inclusion trade-off behind infrastructure investments. Our sample covers 20 countries not included in \citet{fajgelbaum2020optimal} and similar studies we are aware of. Using a reduced form solution, we also infer job gains in each country from these investments---a key policy priority for the World Bank's allocation of spending. Last but not least, we also model optimal investments into the road network of the entire Europe and Central Asia (ECA) region, highlighting the need to invest in upgrading of Eastern European roads to foster greater market access throughout the region. \newline %both in terms of road network expansion and upgrading, 
...
The compensating network expansion ranges from 17.3\% (Montenegro) to 40.1\% (Estonia). Alternatively, countries can upgrade their network---increasing the travel speed---with the same purpose. On average, a network has to be upgraded by 64.8\% to overcome losses from suboptimal infrastructure placement. %This represents investments that range from (\$value) to (\$value). 
...
\section{Job and Markdown Responses to Investments}
...
Beyond national-level analysis, we examine optimal investments in the regional ECA transport network connecting 281 key cities across the macro-region. We identify 274 high-potential new links that would decrease road distance by at least 50\%, with total investment potential of 74.1 billion 2015 USD (51.6 billion for upgrades, 22.5 billion for new construction). Optimal \$10-25 billion investment scenarios reveal that re-establishing connectivity along the Russia-Ukraine border yields the highest marginal returns, while upgrading routes to major metropoles like Moscow and Istanbul also generates substantial benefits. These investments yield welfare gains of up to 2\% in Ukraine, with notable indirect benefits for Central Asia despite receiving little direct investment. The analysis highlights the importance of regional coordination in infrastructure planning, as investments in Eastern Europe create positive spillovers throughout the region. \newline

These findings suggest that mistakes have been made in the spatial prioritization of road network investments in the ECA region, and getting investments right from the start is highly beneficial. Spatial economic models considering aggregate welfare, employment, and productivity should be taken into account---alongside social equity, environmental, and other considerations---when planning or allocating funds to major infrastructure projects, both at the national and regional levels.
...
\end{equation}
Taking logs and differentiating w.r.t. $\eta$ yields
%\begin{equation}
